...
hist(data.df$Global_active_power, col="red", main = "Global Active Power", xlab = "Global Active Power(kilowatts)")
plot(data$datetime ,data$Voltage, main = " ", xlab="datetime", 
     ylab ="Voltage", type="l")
...
plot(data$datetime ,data$Global_reactive_power, main = "", xlab="datetime", ylab="Global_reactive_power",
      type="l")
